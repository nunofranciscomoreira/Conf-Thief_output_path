'''
Wrapper to run conf_thief.py using multiple threads
Splits huge dictionary into one word files
Outputs to path with matched keyword on the folder name
'''
import os
import shutil
...
def run_scrapper(keyword_to_test):
    ...
    cmd = f'python3 conf_thief.py -c {args.cURL} -u {args.username} \
